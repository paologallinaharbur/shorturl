...
func (o *GetURLURL) Build() (*url.URL, error) {
	...
	if shortURL != "" {
		...
		return nil, errors.New("shortUrl is required on GetURLURL")
	}
...
func (o *GetURLURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetURLURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetURLURL")
	}
